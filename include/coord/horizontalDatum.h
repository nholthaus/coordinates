...
inline namespace coord
{
    ...
    namespace horizontalDatums
    {
        ...
        struct ITRF2014 : detail::_ITRF_t, HorizontalDatum<
                              ...
                              ppb_per_year{-0.03000 } // Drz = 0.00000 mas/yr
                          >
        {
        };
        ...
        struct ITRF2000 : detail::_ITRF_t, HorizontalDatum<
                              ...
                              units::unit_value_t<units::velocity::millimeters_per_year, -18, 10>,
                              // Dtz = -0.00180 m/yr
        ...
        struct ITRF93 : detail::_ITRF_t, HorizontalDatum<
                            ...
                            units::unit_value_t<units::velocity::ppb_per_year, 9, 100>, // S = 0.09000 ppb/yr
                            units::unit_value_t<units::angular_velocity::mas_per_year, -11, 100>,
                            // Drx = -0.11000 mas/yr
                            units::unit_value_t<units::angular_velocity::mas_per_year, -19, 100>,
                            // Dry = -0.19000 mas/yr
    ...
    namespace traits
    {
        ...
        {
            typedef typename T::reference_frame reference_frame;
            ///< Unit type that the unit was derived from. May be a `base_unit` or another `unit`. Use the `base_unit_of` trait to find the SI base unit type. This will be `void` if type `T` is not a unit.
            typedef typename T::reference_ellipsoid reference_ellipsoid;
            ///< `std::ratio` representing a datum translation to the base unit (i.e. degrees C to degrees F conversion). This will be `void` if type `T` is not a unit.
        };
        ...
        struct is_itrf : std::integral_constant<bool,
                                                ...
                                                !std::is_same<
                                                    typename coord::traits::horizontal_datum_traits<T>::reference_frame,
                                                    void>::value &&
                                                !std::is_same<
                                                    typename coord::traits::horizontal_datum_traits<
                                                        T>::reference_ellipsoid, void>::value>
        {
        };
        ...
        struct is_horizontal_datum : std::integral_constant<bool,
                                                            coord::traits::is_helmert_7param_coefficients<T>::value &&
                                                            is_itrf<typename coord::traits::horizontal_datum_traits<
                                                                T>::reference_frame>::value &&
                                                            (traits::is_ellipsoid<typename
                                                                    traits::horizontal_datum_traits<
                                                                        T>::reference_ellipsoid>::value ||
                                                                is_itrf<typename traits::horizontal_datum_traits<
                                                                    T>::reference_ellipsoid>::value)
            >
        {
        };
